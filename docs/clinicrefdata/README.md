...
| `docs/clinicrefdata/Insurance Carriers.md` | `reference-only` | Human reference sheet for insurance-carrier suggestions. | `No` | `src/PTDoc.Application/Data/IntakeSupplementalReferenceData.json` |
