...
* **Lhermitte’s Sign** – Cervical cord dysfunction (e.g., MS)
...
* **Allen’s Test** – Vascular insufficiency (radial/ulnar artery)
...
* **Anterior Drawer Test (ankle)** – ATFL (lateral ankle) sprain
