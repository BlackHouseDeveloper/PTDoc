...
public sealed class PatientInfoRouteTests : TestContext
{
    ...
    [Fact]
    public void AuthorizationDateRangeValidation_DisablesSaveWhenStartIsAfterEnd()
    {
        var patientId = Guid.NewGuid();
        var patient = new PatientResponse
        {
        ...
        cut.Find("#pi-auth-start").Input("2026-04-01");
        cut.Find("#pi-auth-end").Input("2026-03-01");
