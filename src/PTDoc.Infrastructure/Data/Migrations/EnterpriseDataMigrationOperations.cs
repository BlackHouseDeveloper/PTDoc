...
public static class EnterpriseDataMigrationOperations
{
        ...
        bool supportsAlterTableForeignKeys = true)
    {
        migrationBuilder.CreateTable("ProviderDirectoryEntries", table => new
        {
            ...
            Specialty = table.Column<string>(maxLength: 150, nullable: true),
            TaxonomyCode = table.Column<string>(maxLength: 20, nullable: true),
            ...
            SubmissionSource = table.Column<int>(nullable: false),
            SubmittedByUserId = table.Column<Guid>(nullable: true),
            ReviewedByUserId = table.Column<Guid>(nullable: true),
            SubmittedAtUtc = table.Column<DateTime>(nullable: false),
            ReviewedAtUtc = table.Column<DateTime>(nullable: true),
            ReviewReason = table.Column<string>(maxLength: 500, nullable: true),
        ...
        migrationBuilder.CreateTable("PatientInsurancePolicies", table => new
        {
            ...
            ClinicId = table.Column<Guid>(nullable: true),
            CoveragePriority = table.Column<int>(nullable: false),
            CarrierKey = table.Column<string>(maxLength: 100, nullable: true),
            CarrierDisplayName = table.Column<string>(maxLength: 200, nullable: true),
            PayerType = table.Column<int>(nullable: false),
            MemberOrPolicyNumber = table.Column<string>(maxLength: 100, nullable: true),
            ...
            PlanYearType = table.Column<int>(nullable: false),
            DeductibleAmount = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            DeductibleMet = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            OutOfPocketMaximum = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            OutOfPocketMet = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            CopayAmount = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            CoinsurancePercent = table.Column<decimal>(precision: 5, scale: 2, nullable: true),
            AdjusterName = table.Column<string>(maxLength: 150, nullable: true),
            AdjusterPhone = table.Column<string>(maxLength: 30, nullable: true),
            AdjusterEmail = table.Column<string>(maxLength: 255, nullable: true),
            AdjusterFax = table.Column<string>(maxLength: 30, nullable: true),
            Status = table.Column<int>(nullable: false),
            IsArchived = table.Column<bool>(nullable: false),
            LastModifiedUtc = table.Column<DateTime>(nullable: false),
            ModifiedByUserId = table.Column<Guid>(nullable: false),
        ...
        migrationBuilder.CreateTable("NoteTemplates", table => new
        {
            ...
            ActiveVersionId = table.Column<Guid>(nullable: true),
            IsArchived = table.Column<bool>(nullable: false),
        ...
        migrationBuilder.CreateTable("PatientProviderRelationships", table => new
        {
            Id = table.Column<Guid>(nullable: false),
            PatientId = table.Column<Guid>(nullable: false),
            ProviderDirectoryEntryId = table.Column<Guid>(nullable: false),
            ClinicId = table.Column<Guid>(nullable: true),
        ...
        {
            Id = table.Column<Guid>(nullable: false),
            PatientInsurancePolicyId = table.Column<Guid>(nullable: false),
            PatientId = table.Column<Guid>(nullable: false),
            ClinicId = table.Column<Guid>(nullable: true),
            AuthorizationType = table.Column<int>(nullable: false),
            ...
            AuthorizedUnits = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            UsedUnits = table.Column<decimal>(precision: 18, scale: 2, nullable: true),
            VisitLimitPeriod = table.Column<int>(nullable: false),
            ReauthorizationDueDate = table.Column<DateTime>(nullable: true),
            VisitAlertThreshold = table.Column<int>(nullable: true),
        ...
        {
            Id = table.Column<Guid>(nullable: false),
            NoteTemplateId = table.Column<Guid>(nullable: false),
            ClinicId = table.Column<Guid>(nullable: true),
            VersionNumber = table.Column<int>(nullable: false),
            Status = table.Column<int>(nullable: false),
            SchemaJson = table.Column<string>(nullable: false),
            CreatedByUserId = table.Column<Guid>(nullable: false),
            SubmittedByUserId = table.Column<Guid>(nullable: true),
            ReviewedByUserId = table.Column<Guid>(nullable: true),
            CreatedAtUtc = table.Column<DateTime>(nullable: false),
