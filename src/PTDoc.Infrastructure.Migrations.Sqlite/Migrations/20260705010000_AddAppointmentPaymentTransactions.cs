...
namespace PTDoc.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260705010000_AddAppointmentPaymentTransactions")]
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionId = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    AuthorizationCode = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    GatewayErrorCode = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    GatewayErrorMessage = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ProcessedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    InvoiceNumber = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true)
                },
                constraints: table =>
                {
