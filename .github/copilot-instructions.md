...
6. **File placement first** - consult `docs/ARCHITECTURE.md` for file placement decisions (note: `architect.md` does not exist; always use `docs/ARCHITECTURE.md` instead)
